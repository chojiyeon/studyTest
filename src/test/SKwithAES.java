 ...
 * COPYRIGHT (C) 2019 MCOMPLUS.COM ALL RIGHTS RESERVED.
 *
 ...
 *
 *
 * Program		: com.mcomplus.deful
 * Description	:
 * Environment	: JRE 1.7 or more
 * File			: SKwithAES.java
 * Notes		: Symmetric Key-based encryption(SK) with AES(Advanced Encryption Standard, Data Encryption Standard for the next generation of DES)
 * 				: Required Java Cryptography Extension(JCE) Unlimited Strength Jurisdiction Policy File(http://www.oracle.com/technetwork/java/javase/downloads/index.html)
 * History		: [NO][Programmer][Description]
 *				: [20190220000000][pluto@mcomplus.com][CREATE: Initial Release]
 */
package test;
...
public class SKwithAES {
	 ...
	 * <code>String encodeText = aes.encode("pluto@mcomplus.com", "UTF-8");</code>
	 * </p>
	 */
	...
	public static void main(String[] args) throws InvalidKeyException, UnsupportedEncodingException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException{
		...
		// AES-256
		String key = "123456789012345678901234567890wq";
		// AES-128
		...
		// Encrypt
		plainText  = "<xml><record><req_aliac_cd>R01</req_aliac_cd><card_no>1019177100000390</card_no></record></xml>";
		encodeText = aes.encode(plainText, "UTF-8");
		System.out.println("Encode ["+ encodeText + "]");
		 
		// Decrypt
		decodeText = aes.decode("I/wuFbEmqkWwp7gCZAlP6+88Pe+bFaMCGTwv4d4Tp8uyo6/VhEvJiJwnb8A4hHZoVY+MmCOKblYqkbH9H2tithQdQNewzUIIkXy8utXH4gy3lq1TiPEcIj2Pw9tSSFo0", "UTF-8");
