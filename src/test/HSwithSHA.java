 ...
 * COPYRIGHT (C) 2015 PLUTOZONE.COM ALL RIGHTS RESERVED.
 *
 ...
 * File			: HSwithSHA.java
 * Notes		: HaSh with SHA(Secure Hash Algorithm): http://www.example-code.com/java/crypt_hash_algorithms.asp
 * History		: [NO][Programmer][Description]
 *				: [20151209184800][pluto@plutozone.com][CREATE: Initial Release]
 *				: [20151228131700][pluto@plutozone.com][INSERT: Example]
 */
package test;
